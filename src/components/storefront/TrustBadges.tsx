const badges = [
  { title: "Free UK delivery", subtitle: "On orders over £50", icon: "M3 10h11l3 4h3v4H3z M7 18a2 2 0 100 4 2 2 0 000-4z M16 18a2 2 0 100 4 2 2 0 000-4z" },
...
export function TrustBadges() {
  return (
    <div className="grid grid-cols-2 gap-3">
      {badges.map((b) => (
        <div key={b.title} className="flex items-start gap-2.5 rounded-button border border-border-subtle p-3">
